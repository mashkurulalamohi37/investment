                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _assetDetailRow(isBangla ? 'প্রকল্পের পরিমাপ' : 'Project Area', '${asset.landAreaDecimals} Decimals (শতাংশ)', palette, isDark),
                            _assetDetailRow(isBangla ? 'প্রকল্প কোড' : 'Project Code', asset.deedNumber, palette, isDark),
                            _assetDetailRow(isBangla ? 'সম্পদের স্থিতি' : 'Asset Status', asset.mutationKhatian, palette, isDark),
                            _assetDetailRow(isBangla ? 'বিনিয়োগকৃত তহবিল' : 'Acquisition Cost', CurrencyFormatter.format(asset.purchaseValue, isBangla: isBangla), palette, isDark),
                            _assetDetailRow(isBangla ? 'বর্তমান প্রজেক্ট ভ্যালু' : 'Current Valuation', CurrencyFormatter.format(asset.currentValue, isBangla: isBangla), palette, isDark),
                          ],
                        ),
                      ),
                    ],
